      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-maroon">
            ...
            <a href="<?php echo base_url('reports/') ?>" class="small-box-footer">More Info <i
                class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-xs-6">
          <div class="small-box bg-teal">
            ...
            <a href="<?php echo base_url('tables/') ?>" class="small-box-footer">More Info <i
                class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
